...
def useGoods():  #equip the items for captain
    if bag == {}:
        ...
        for i in list(d.keys())[6:12]:
            if n.lower() == i:  #choose the person
                ...
                if n2 == '1':
                    ...
                    if bag['hero'] != 0:
                        print('Equipping the item successfully!')
                        for attr in range(1, 4):#attribution change
...
def checkAttr(): #view the attribution
